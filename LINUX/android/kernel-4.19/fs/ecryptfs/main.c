...
enum { ecryptfs_opt_sig, ecryptfs_opt_ecryptfs_sig,
       ...
       ecryptfs_opt_check_dev_ruid, ecryptfs_opt_info_file_lock,
       ecryptfs_opt_err };
...
static const match_table_t tokens = {
	...
	{ecryptfs_opt_info_file_lock, "ecryptfs_info_file_lock"},
	...
	*check_ruid = 0;
	...
	while ((p = strsep(&options, ",")) != NULL) {
		...
		case ecryptfs_opt_check_dev_ruid:
			*check_ruid = 1;
			break;
		case ecryptfs_opt_info_file_lock:
			mount_crypt_stat->flags |=
				ECRYPTFS_INFO_FILE_LOCK;
			break;
