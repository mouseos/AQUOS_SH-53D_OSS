...
/**** [SX3-696] API for CC recovery: START ****/
extern int read_cc_safety_level(void); // [SX3-3910]
extern void handle_cc_recovery(struct device *dev);
/**** [SX3-696] API for CC recovery: END   ****/

/**** [SX3-2669] API to write battery and charging info according to event_id: START ****/
extern void write_battlog(int sharp_battlog_event_id);
/**** [SX3-2669] API to write battery and charging info according to event_id: END   ****/
