...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct custom1;      /* custom1 for stereo relative information */
	...
	kal_uint8 frame_time_delay_frame; /* dualcam Bokeh sw sync enable */
	...
	/* 0, high speed signal auto detect; 1, use settle delay,unit is ns, default is auto detect, don't modify this para */
