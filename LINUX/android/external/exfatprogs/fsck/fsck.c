 ...
 */
#define FSCK_EXIT_CORRECTED		0x04
...
/* SHARP_EXTEND [FSI-22-3-1] Add fsck timed out Start */
#ifdef EXFSCK_CHECK_TIMEOUT_DIR
#define FSCK_EXIT_TIMEOUT_ERROR		0x00
#endif /* EXFSCK_CHECK_TIMEOUT_DIR */
/* SHARP_EXTEND [FSI-22-3-1] Add fsck timed out End */
...
/* SHARP_EXTEND [FSI-22-3-1] Add fsck timed out Start */
#ifdef EXFSCK_CHECK_TIMEOUT_DIR
		clock_gettime(CLOCK_BOOTTIME, &tsEnd);
		duration = tsEnd.tv_sec - (&exfat->tsStart)->tv_sec;
		if (duration > 60) {
			ret = -ETIMEDOUT;
			fsck_err(dir->parent, dir,
				"failed to read_children(time out). ret=%d time=%d\n", ret, duration);
			goto err;
		}
#endif /* EXFSCK_CHECK_TIMEOUT_DIR */
/* SHARP_EXTEND [FSI-22-3-1] Add fsck timed out End */
...
/* SHARP_EXTEND [FSI-22-3-1] Add fsck timed out Start */
#ifdef EXFSCK_CHECK_TIMEOUT_DIR
			if (dir_errors == -ETIMEDOUT) {
				fsck_err(dir->parent, dir, "failed to check dentries: time out");
				goto out;
			}
#endif /* EXFSCK_CHECK_TIMEOUT_DIR */
/* SHARP_EXTEND [FSI-22-3-1] Add fsck timed out End */
...
/* SHARP_EXTEND [FSI-22-3-1] Add fsck timed out Start */
#ifdef EXFSCK_CHECK_TIMEOUT_DIR
	clock_gettime(CLOCK_BOOTTIME, &exfat->tsStart);
#endif /* EXFSCK_CHECK_TIMEOUT_DIR */
/* SHARP_EXTEND [FSI-22-3-1] Add fsck timed out End */
...
/* SHARP_EXTEND [FSI-22-3-1] Add fsck timed out Start */
		...
		exit_code = FSCK_EXIT_TIMEOUT_ERROR;
#endif /* EXFSCK_CHECK_TIMEOUT_DIR */
/* SHARP_EXTEND [FSI-22-3-1] Add fsck timed out End */
	else if (ret)
