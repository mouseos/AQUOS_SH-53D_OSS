 ...
 */
	memset(ppbr->boot_code, EXFAT_MAIN_BOOT_SECTOR_BOOTCODE, 390);
...
/* SHARP_EXTEND [FSI-22-7-1] Fix Boundary Unit Start
 ...
 */
	finfo.fat_byte_off = finfo.fat_byte_len = bd->offset / 2;
	finfo.clu_byte_off = bd->offset;
/* SHARP_EXTEND [FSI-22-7-1] Fix Boundary Unit End */
