...
/* SHARP_EXTEND [FSI-22-3-1] Add fsck timed out Start */
#include <android/log.h>
#define TAG "libexfat"
/* SHARP_EXTEND [FSI-22-3-1] Add fsck timed out End */
...
/* SHARP_EXTEND [FSI-22-5-1] Set block device offset Start */
/* Boundary_Unit of up to 128GB */
#define EXFAT_BOUNDARY_UNIT_UP_TO_128GB 32768
/* Boundary_Unit of up to 512GB */
#define EXFAT_BOUNDARY_UNIT_UP_TO_512GB 65536
/* Boundary_Unit of up to 2048GB */
#define EXFAT_BOUNDARY_UNIT_UP_TO_2048GB 131072

/* Data Area size up to 128GB */
#define EXFAT_MAX_DATA_AREA_SIZE_128GB 0xFFB8000
/* Data Area size up to 512GB */
#define EXFAT_MAX_DATA_AREA_SIZE_512GB 0x3FFB0000
/* Data Area size up to 2048GB */
#define EXFAT_MAX_DATA_AREA_SIZE_2048GB 0xFFFA0000
/* SHARP_EXTEND [FSI-22-5-1] Set block device offset End */
 ...
 */
#define exfat_err(...) __android_log_print(ANDROID_LOG_ERROR, TAG, __VA_ARGS__)
#define exfat_info(...) __android_log_print(ANDROID_LOG_INFO, TAG, __VA_ARGS__)
#define exfat_debug(...) __android_log_print(ANDROID_LOG_DEBUG, TAG, __VA_ARGS__)
/* SHARP_EXTEND [FSI-22-3-1] Add fsck timed out End */
