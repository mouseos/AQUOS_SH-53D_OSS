...
//FIH-Sean-incompatible function pointer types initializing 'int (*)(struct i2c_client *)'
// with an expression of type 'int (struct i2c_client *, const struct i2c_device_id *)'
//int nfc_i2c_dev_probe(struct i2c_client *client,
//		      const struct i2c_device_id *id);
int nfc_i2c_dev_probe(struct i2c_client *client);
//FIH-Sean-incompatible function pointer types initializing 'void (*)(struct i2c_client *)'
