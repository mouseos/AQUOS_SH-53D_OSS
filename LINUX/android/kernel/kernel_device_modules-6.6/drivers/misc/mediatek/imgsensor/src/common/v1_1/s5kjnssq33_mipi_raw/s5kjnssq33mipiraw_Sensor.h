 ...
 *
 ****************************************************************************/
#ifndef _S5KJNSSQ33MIPI_SENSOR_H
#define _S5KJNSSQ33MIPI_SENSOR_H
...
struct imgsensor_info_struct {
	...
	struct imgsensor_mode_struct custom1;       //custom1 for night mode relative information

	kal_uint8 ae_shut_delay_frame;	      //shutter delay frame for AE cycle
	kal_uint8 ae_sensor_gain_delay_frame; //sensor gain delay frame for AE cycle
	kal_uint8 ae_ispGain_delay_frame;     //isp gain delay frame for AE cycle
	kal_uint8  frame_time_delay_frame; //[Alex] Bokeh sw sync enable
