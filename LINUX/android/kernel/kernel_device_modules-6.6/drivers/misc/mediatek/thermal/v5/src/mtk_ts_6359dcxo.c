...
static long mt6359dcxo_cur_temp;
/*
...
static int mt6359dcxo_change_mode
...
static struct thermal_zone_device_ops mt6359dcxo_dev_ops = {
	...
	.change_mode = mt6359dcxo_change_mode,
...
static int mt6359dcxo_register_thermal(void)
{
	...
	thz_dev = mtk_thermal_zone_device_register(
			"mt6359dcxo", trips, num_trip, NULL,
...
static const struct proc_ops mt6359dcxo_fops = {
	.proc_open = mt6359dcxo_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
	.proc_write = mt6359dcxo_write,
	.proc_release = single_release,
};

static int mt6359dcxo_probe(struct platform_device *pdev)
{
	int i, err = 0;
...
static const struct of_device_id mt6359dcxo_of_match[] = {
		{.compatible = "mediatek,mt6359dcxo",},
		{},
};
MODULE_DEVICE_TABLE(of, mt6359dcxo_of_match);
static struct platform_driver mt6359dcxo_driver = {
		.probe = mt6359dcxo_probe,
		.driver = {
			.name = "mt6359dcxo",
			.of_match_table = mt6359dcxo_of_match,
		},
};
int mt6359dcxo_init(void)
{
	platform_driver_register(&mt6359dcxo_driver);
	return 0;
}

void mt6359dcxo_exit(void)
{
	mt6359dcxo_unregister_thermal();
	mt6359dcxo_unregister_cooler();
	mtkTTimer_unregister("mt6359dcxo");
	platform_driver_unregister(&mt6359dcxo_driver);
}
