...
#endif
//FIH-Thermal-Add+[
extern int mtk_cooler_tethering_init(void);
extern int mtk_cooler_tethering_exit(void);
extern int mtk_cooler_ushutdown_init(void);
extern int mtk_cooler_ushutdown_exit(void);
extern int mtkts_quiet_init(void);
extern void mtkts_quiet_exit(void);
extern int mtkts_camera_init(void);
extern void mtkts_camera_exit(void);
extern int mtkts_chargerntc_init(void);
extern void mtkts_chargerntc_exit(void);
//FIH-Thermal-Add+]
