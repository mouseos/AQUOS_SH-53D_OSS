...
static const struct proc_ops mt6359vproc_fops = {
	.proc_open = mt6359vproc_open,
	.proc_read = seq_read,
...
MODULE_DEVICE_TABLE(of, mt6359vproc_of_match);
static struct platform_driver mt6359vproc_driver = {
		.probe = mt6359vproc_probe,
		.driver = {
			.name = "mt6359vproc",
