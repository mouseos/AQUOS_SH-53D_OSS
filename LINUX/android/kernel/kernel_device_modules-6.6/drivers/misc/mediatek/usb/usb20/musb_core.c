...
static void mt_usb_enable(struct musb *musb)
{
	...
	DBG(0, "end, <%d,%d,%d,%d>\n",
		virt_enable, virt_disable,
		real_enable, real_disable);
	//**** [SX4V-817] write usb event to battery log: plugin ++++
	printk("FIHBATTLOG::%d\n", E_BATTLOG_CHG_INSERT_USB);
	//**** [SX4V-817] write usb event to battery log: plugin ----
...
static void mt_usb_disable(struct musb *musb)
{
	...
	//**** [SX4V-817] write usb event to battery log: plugout ++++
	printk("FIHBATTLOG::%d\n", E_BATTLOG_CHG_REMOVE_USB);
	//**** [SX4V-817] write usb event to battery log: plugout ----
...
#define	VUSB33_VOL_MAX 3070000
	...
	/* [SX3-355] Disable host suspend mode */
	pr_notice("[usb_host]: Disable host suspend mode enforcibly.\n");
