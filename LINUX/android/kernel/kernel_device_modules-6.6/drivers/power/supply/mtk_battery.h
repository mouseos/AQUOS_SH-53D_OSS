...
/**** [SX3-696] cc_safety structure: START ****/
struct S_cc_safety {
	int               cc_safety_level;
	int               cc_safety_level_test_enable;
	int               cc_safety_level_test_val;
	struct            tcpc_device *tcpc;
	struct timespec64 cc_safety_ts64_otp_enable;
};
/**** [SX3-696] cc_safety structure: END   ****/
...
/* FIH mtk_battery.c function */
extern void fih_send_charger_info(u32 event,bool en);
extern bool fih_get_charger_info(u32 event);
/*mtk_battery.c end */
...
/* mtk-battery-manager.c */
extern int show_soc(void);
extern int battery_manager_info(u32 event);
/* mtk-battery-manager.c */
...
/* FIH function */
extern int get_battery_temp(bool update);
extern int get_battery_columb(void);

/* [SX3-696][REQ][Charger][SW-PMIC-0043] */
extern void set_cc_safety_to_battery(struct S_cc_safety* cs);
extern struct S_cc_safety* get_cc_safety_from_battery(void);
extern void print_cc_safety_state(struct S_cc_safety* cs, char* mod_name);
...
/* customized charging status */
enum sharp_enable_charging {
	jeita_charging,
	power_path_charging,
	direct_charging,
	charging_online,
	thermal12_charging,
	thermal13_charging,
	thermal_usb_charging,
};

struct customized_charging_status_source{
	bool jeita_charging;
	bool power_path_charging;
	bool direct_charging;
	bool charging_online;
	bool thermal12_charging;
	bool thermal13_charging;
	bool thermal_usb_charging;
};

struct customized_capacity{
	int pre_capacity;
...
#ifndef sharp_battery_log
#define sharp_battery_log
/**** [SX3-2669] Sharp battlog event_id definitions: START ****/
enum sharp_battlog_t {
	// battery relative
	SH_BATTLOG_BATT_REPORT_NORM			= 5,
	SH_BATTLOG_BATT_REPORT_CHG			= 6,

	// charging relative
	SH_BATTLOG_CHG_END 					= 14,
	SH_BATTLOG_CHG_START 				= 15,
	SH_BATTLOG_CHG_COMP 				= 16,
	SH_BATTLOG_CHG_ERROR 				= 17,

	// FGIC relative
	SH_BATTLOG_FGIC_EX0					= 7,
	SH_BATTLOG_FGIC_EX10 				= 26,
	SH_BATTLOG_FGIC_EX20 				= 27,
	SH_BATTLOG_FGIC_EX30 				= 28,
	SH_BATTLOG_FGIC_EX40 				= 29,
	SH_BATTLOG_FGIC_EX50 				= 30,
	SH_BATTLOG_FGIC_EX60 				= 31,
	SH_BATTLOG_FGIC_EX70 				= 32,
	SH_BATTLOG_FGIC_EX80 				= 33,
	SH_BATTLOG_FGIC_EX90 				= 34,
	SH_BATTLOG_FGIC_EX100 				= 35,

	// usb_connector otp
	SH_BATTLOG_DETECT_USB_HIGH_TEMP		= 177,
	SH_BATTLOG_RELEASE_USB_HIGH_TEMP	= 178,
};

/**** [SX3-2669] Sharp battlog event_id definitions: END   ****/
#endif