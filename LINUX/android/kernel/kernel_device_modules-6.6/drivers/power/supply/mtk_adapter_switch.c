...
{
	int ret = 0;
	adapter_switch_err("%s %d:   info->setting.adapter_priority = %d, info->ta_status[UFCS] =%d ,info->ta_status[PD] = %d\n"
	, __func__,__LINE__,info->setting.adapter_priority,info->ta_status[UFCS],info->ta_status[PD]);
