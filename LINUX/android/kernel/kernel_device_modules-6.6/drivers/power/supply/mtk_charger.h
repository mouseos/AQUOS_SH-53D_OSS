...
#define JEITA_TEMP_T3_TO_T4_BAT_CUR  2500000
#define JEITA_TEMP_T2_TO_T3_BAT_CUR  3000000
#define JEITA_TEMP_T1_TO_T2_BAT_CUR  1000000 
...
struct sw_jeita_data {
	...
	int pre_sm_customized;
};

struct damage_info_data{
	int stat;
	long int start_time;
	long int end_time;
	long int total_time;
	long int start_coulomb;
	long int end_coulomb;
...
struct charger_custom_data {
	...
	int pd_charger_current; /*SX4V-284*/

	/* sw jeita */
	int jeita_bat_current;
...
struct mtk_charger {
	...
	unsigned int persist_power_path_enable;
};
...
extern int set_tcpc_to_charger(struct tcpc_device *tcpc);
...
enum mt6360_pmu_info_fih {
	mt6360_ibus = 0,
	mt6360_ibat
};

enum send_to_mt6360_fih {
	PD_START = 0,
	DCP_input_current_max
};

extern int mt6360_info(u32 event);
