...
#define tpd1_DMESG(a, arg...) \
	pr_info(CTP_NAME ":[%s:%d] " a, __func__, __LINE__, ##arg)
...
extern void tpd_sitronix_gpio_power_enable(int level);
struct tpd1_device {
...
extern const struct of_device_id touch_sitronix_of_match[];
/*hc --------------------add */
/*
...
extern void sitronix_touch_driver_init(void);
extern void sitronix_touch_driver_exit(void);
extern int tpd1_log_init(void);
extern void tpd1_log_exit(void);
extern void sitronix_suspend(void);
extern void sitronix_resume(void);
#endif
