...
extern void tpd_gpio_power_enable(int level);
struct tpd_device {
...
extern void ilitek_touch_driver_init(void);
extern void ilitek_touch_driver_exit(void);
extern int tpd_log_init(void);
extern void tpd_log_exit(void);
extern void focaltech_suspend(void);
extern void focaltech_resume(void);
#endif
