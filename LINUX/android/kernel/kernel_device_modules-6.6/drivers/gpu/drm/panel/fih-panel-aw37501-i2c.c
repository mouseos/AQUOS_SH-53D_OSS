...
#define I2C_I2C_LCD_BIAS_CHANNEL 7  //for I2C channel 7
...
int fih_aw37501_write_bytes(unsigned char addr, unsigned char value)
{
	int ret = 0;
...
EXPORT_SYMBOL(fih_aw37501_write_bytes);
