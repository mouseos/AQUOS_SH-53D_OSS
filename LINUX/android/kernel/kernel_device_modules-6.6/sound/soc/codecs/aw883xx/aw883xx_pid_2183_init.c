...
int aw883xx_pid_2183_dev_init(struct aw_device *aw_pa)
{
	...
	aw_pa->sysst_desc.st_check = AW_PID_2183_BIT_SYSST_SWS_CHECK;
	...
	aw_pa->noise_gate_en.check_mask = AW_PID_2183_SWS_MASK;

	aw_pa->eps_en.reg = AW_PID_2183_BSTCTRL10_REG;
	aw_pa->eps_en.eps_mask = AW_PID_2183_EN_HVBAT_MASK;
	aw_pa->eps_en.check_mask = AW_PID_2183_BSTS_MASK;
