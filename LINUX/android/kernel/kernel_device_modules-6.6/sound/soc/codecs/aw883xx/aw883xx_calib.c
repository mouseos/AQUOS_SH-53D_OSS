...
//FIH modified start. Customise calibration data location.
/*write cali to persist file example*/
//#define AWINIC_CALI_FILE  "/mnt/vendor/persist/factory/audio/aw_cali.bin"
#define AWINIC_CALI_FILE  "/mnt/vendor/nvcfg/audio/aw_cali.bin"
//FIH modified end.
...
static struct class aw_cali_class = {
	.name = "smartpa",
	//.owner = THIS_MODULE, //FIH: this field does not exist in the latest kernel
};
